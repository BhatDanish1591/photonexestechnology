...
export default function BestCompanySection() {
  ...
  const rotateX = useSpring(useTransform(mouseY, [-180, 180], [7, -7]), { stiffness: 200, damping: 35 });
  const rotateY = useSpring(useTransform(mouseX, [-180, 180], [-7, 7]), { stiffness: 200, damping: 35 });
  ...
  return (
    <section className="pt-12 pb-20 lg:pt-16 lg:pb-32 relative overflow-hidden bg-[#fafafa]">
      ...
      <div className="absolute top-1/3 left-10 w-72 h-72 rounded-full bg-teal-500/5 blur-3xl pointer-events-none" />
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center relative z-10">
        ...
        {/* Right Side: Image with 3D Mouse Tilt & Floating Badge */}
        <div className="relative flex justify-center lg:justify-end mt-12 lg:mt-0">
          ...
          >
            ...
            <motion.div 
              className="relative w-full aspect-[4/3] overflow-hidden rounded-l-[150px] rounded-r-3xl shadow-2xl border-4 border-white z-10"
            ...
            {/* Floating Badge */}
            <motion.div 
              className="absolute -top-8 -left-8 md:-top-12 md:-left-12 bg-[#064e3b] rounded-2xl p-4 md:p-5 pr-8 md:pr-12 flex items-center gap-4 shadow-2xl z-20 animate-[float_4s_ease-in-out_infinite]"
